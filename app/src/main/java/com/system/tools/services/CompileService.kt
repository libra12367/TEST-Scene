package com.system.tools.services
        ...
        if (compile_method == "reset") {
            ...
            for (packageName in packageNames) {
                if (true) {
                    ...
                    cmdBuilder.append("am broadcast -n com.system.tools/com.system.tools.ReceiverCompileState --ei current $current --ei total $total --es packageName $packageName\n")
            ...
            cmdBuilder.append("am broadcast -n com.system.tools/com.system.tools.ReceiverCompileState --ei current $total --ei total $total --es packageName OK\n")
