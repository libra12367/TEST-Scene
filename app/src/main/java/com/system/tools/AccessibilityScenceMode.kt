...
import com.system.data.EventBus
import com.system.data.EventType
import com.system.data.GlobalStatus
import com.system.data.IEventReceiver
import com.system.library.basic.InputMethodApp
import com.system.library.basic.LauncherApps
import com.system.library.calculator.Flags
import com.system.scene_mode.AppSwitchHandler
import com.system.scene_mode.AutoClickInstall
import com.system.scene_mode.AutoSkipAd
import com.system.store.SpfConfig
import com.system.utils.AutoSkipCloudData
import com.system.tools.popup.FloatLogView
...
public class AccessibilityScenceMode : AccessibilityService(), IEventReceiver {
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent) {
        ...
        */
        ...
        if (packageName != null) {
            when {
                packageName == "com.system.gesture" || packageName == "com.system.filter" -> {
                    return
                }
                /*
                ...
                */
                // packageName == "com.system.tools" -> return
        ...
        if (effectiveWindows.isNotEmpty()) {
            try {
                ...
                for (window in effectiveWindows) {
                    ...
                    if (wp == null || wp == "android" || wp == "com.android.systemui" || wp == "com.miui.freeform" || wp == "com.system.gesture" || wp == "com.system.filter" || wp == "com.android.permissioncontroller") {
                        continue
                    }
                    */
                    if (isLandscape) {
